...
SBR_BINS=("sabre")
# SBR_PLUGINS=("libsbr-afl-and-affin.so" "libsbr-afl-and-defer.so" "libsbr-afl-and-sleep.so" "libsbr-afl-and-stdio.so")
SBR_PLUGINS=("libsbr-afl-and-affin.so")

case "$1" in
dicom)
  PROJECT_NAME="dicom"
  AFL_ARGS="-m 512 -i ./conf/in-dicom -P DICOM -c ./conf/dicomclean.sh -E -K -R"
  TARGET_CONF=""
...
ftp)
  PROJECT_NAME="ftp"
  AFL_ARGS="-m 512 -t 5000 -i ./conf/in-ftp -x ./conf/ftp.dict -P FTP -c ./conf/ftpclean.sh -q 3 -s 3 -E -R"
